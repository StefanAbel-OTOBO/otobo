...
sub Data {
    ...
    $Self->{Completeness}        = 0.198637911464245;
...
' => '',
        ...
        'New process ticket' => '',
        'News about OTOBO releases!' => 'Новини за OTOBO са публикувани.',
        'News about OTOBO.' => '',
        ...
        'Product News' => 'Новини за продукта.',
        ...
        'Your email with ticket number "<OTOBO_TICKET>" is merged to "<OTOBO_MERGE_TO_TICKET>".' =>
            'Вашето писмо с номер на билета "<OTOBO_TICKET>" е изравнено с "<OTOBO_MERGE_TO_TICKET>".',
