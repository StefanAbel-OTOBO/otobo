...
sub Data {
    ...
    $Self->{Completeness}        = 0.396465055942922;
...
' => '',
        ...
        'If "LDAP" was selected for Customer::Authmodule, you can check if the user is allowed to authenticate because he is in a posixGroup, e.g. user needs to be in a group xyz to use OTOBO. Specify the group, who may access the system.' =>
            'Hvis "LDAP" er valgt for Customer::Authmodule kan du bestemme om en bruger må logge ind ved at gøre dem til medlem af en possixGroup, f.eks. brugeren skal være medlem af gruppe xyz for at benytte OTOBO. Angiv gruppen der skal have adgang til systemet.',
        ...
        'Merged Ticket <OTOBO_TICKET> to <OTOBO_MERGE_TO_TICKET>.' => 'Samlet sag <OTOBO_TICKET> med <OTOBO_MERGE_TO_TICKET>.',
        'Minute' => '',
        ...
        'New process ticket' => '',
        'News about OTOBO releases!' => 'Nyheder om OTOBO-udgivelser.',
        'News about OTOBO.' => '',
        ...
        'Your email with ticket number "<OTOBO_TICKET>" is bounced to "<OTOBO_BOUNCE_TO>". Contact this address for further information.' =>
            'Din e-mail med sagsnummer "<OTOBO_TICKET>" er overgivet til "<OTOBO_BOUNCE_TO>". Kontakt denne adresse for yderligere information.',
        'Your email with ticket number "<OTOBO_TICKET>" is merged to "<OTOBO_MERGE_TO_TICKET>".' =>
            'Din sag nummer "<OTOBO_TICKET>" er blevet samlet med sag nummer "<OTOBO_MERGE_TO_TICKET>".',
