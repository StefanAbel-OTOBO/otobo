...
sub Data {
    ...
    $Self->{Completeness}        = 0.137343927355278;
...
επεξεργαστείτε τα πιστοποιητικά και ιδιωτικά κλειδιά στο αρχείο συστήματος.',
        ...
        'To be able to use OTOBO you have to enter the following line in your command line (Terminal/Shell) as root.' =>
            'Για να μπορεσετε να χρησιμοπιήσετε το OTOBO πρέπει να είσάγετε την παρακάτω γραμμή στο Terminal command line ώς χρήστης root.',
        'Restart your webserver' => 'Κανετε εποανεκίνηση του webserver.',
        'After doing so your OTOBO is up and running.' => 'Μετά απο αυτή την ενέργεια το OTOBO θα ενεργοποιηθεί.',
        'Start page' => 'Αρχική Σελίδα',
        'Your OTOBO Team' => 'Η ομάδα OTOBO',
        ...
        # Template: Test
        'OTOBO Test Page' => 'OTOBO δοκιμαστική σελίδα',
        'Unlock' => 'Άνοιγμα',
        'Welcome %s %s' => '',
        'Counter' => 'Μετρητής',
        ...
        'OTOBO as provider' => 'OTOBO ως προμηθευτής',
        'Operations' => '',
        'OTOBO as requester' => 'OTOBO ως αιτούντας',
        'Invokers' => '',
        ...
        'Install OTOBO' => 'Εγκατασταση OTOBO',
        'Intro' => 'Εισαγωγή',
        ...
        'OTOBO Daemon is not running.' => 'Ο διεργασία παρασκηνίου του OTOBO δεν εκτελείται.',
...
' => '',
        ...
        'New process ticket' => '',
        'News about OTOBO releases!' => 'Νέα εκδόσεων του OTOBO!',
        'News about OTOBO.' => '',
        ...
        'Your email with ticket number "<OTOBO_TICKET>" is merged to "<OTOBO_MERGE_TO_TICKET>".' =>
            'Το μήνυμά σας με αριθμό δελτίου "<OTOBO_TICKET>" συγχωνεύτηκε με το δελτίο <OTOBO_MERGE_TO_TICKET>" !',
