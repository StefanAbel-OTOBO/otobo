...
sub Data {
    ...
    $Self->{Completeness}        = 0.372542802790108;
    ...
    $Self->{Translation} = {
        ...
        'Configuration Import' => 'Importe la Configuración',
        ...
        'Import ACL configuration(s)' => 'Importar la configuración(es) del ACL',
        'Description' => 'Descripción',
        'To create a new ACL you can either import ACLs which were exported from another system or create a complete new one.' =>
            'Para crear un nuevo ACL puedes importar un ACL exportado de otro sistema o crear uno completamente nueva.',
        'Changes to the ACLs here only affect the behavior of the system, if you deploy the ACL data afterwards. By deploying the ACL data, the newly made changes will be written to the configuration.' =>
            'Los cambios en los ACL solo afectan al comportamiento del sistema si se despliega de nuevo el ACL después de la modificación. Solo después de volver a desplegar el ACL, los cambios serán guardados en la configuración.',
        ...
        'Please note: This table represents the execution order of the ACLs. If you need to change the order in which ACLs are executed, please change the names of the affected ACLs.' =>
            'Tener en cuenta: Esta tabla representa el orden de ejecución de los ACLs. Si es necesario cambiar el orden en el que se ejecutan los ACL, por favor, cambia los nombres de los ACL afectadas.',
        ...
        'Delete Invalid ACL' => 'Borrar ACL inválido',
        'Match settings' => 'Ajustes de concidencia',
        'Set up matching criteria for this ACL. Use \'Properties\' to match the current screen or \'PropertiesDatabase\' to match attributes of the current ticket that are in the database.' =>
            'Configure criterios coincidentes para el ACL. Utilice \'Propiedades\' para hacer coincidir la pantalla actual o \'PropertiesDatabase\' para hacer coincidir los atributos del ticket actual que están en la base de datos.',
        'Change settings' => 'Cambiar Configuración',
        'Set up what you want to change if the criteria match. Keep in mind that \'Possible\' is a white list, \'PossibleNot\' a black list.' =>
            'Configure lo que desea cambiar si los criterios coinciden. Tenga en cuenta que "Posible" es una lista blanca, "PosibleNo" una lista negra.',
        'Check the official %sdocumentation%s.' => 'Consulte la documentación Oficial.',
        ...
        'Create a new ACL by submitting the form data. After creating the ACL, you will be able to add configuration items in edit mode.' =>
            'Cree un nuevo ACL enviando los datos del formulario. Después de crear el ACL, podrá agregar elementos de configuración en modo de edición.',
        ...
        'This language is not present or enabled on the system. This text could be deleted if it is not needed anymore.' =>
            'Este idioma no esta disponible en el sistema. Este texto puede eliminarse si ya no es necesario.',
        'Remove Language' => 'Eliminar Idioma',
        'Text' => 'Texto',
        'Message body' => 'Cuerpo del mensaje',
        'This field is required and must have less than 4000 characters.' =>
            'Este campo es obligatorio y debe tener menos de 4000 caracteres.',
        'Remove About Language' => 'Quitar Idioma',
        ...
        'Add new Calendar' => 'Agregar un Calendario nuevo',
        ...
        'Filter for Calendars' => 'Filtros de Calendarios',
        ...
        'Read only: users can see and export all appointments in the calendar.' =>
            'Solo Lectura: usuarios que pueden ver y exportar todas las citas en el calendario.',
        ...
        'Use options below to narrow down for which tickets appointments will be automatically created.' =>
            'Use las opciones mostradas abajo para acortar las citas de los tickets serán creadas automáticamente.',
        'Queues' => 'Colas',
        ...
        'If desired Calendar is not listed here, please make sure that you have at least \'create\' permissions.' =>
            'Si el Calendario deseado no aparece aquí, asegúrese de tener al menos permisos de "crear".',
        'Upload' => 'Subir',
        ...
        'Filter for Notifications' => 'Filtro para las Notificaciones',
        'Filter for notifications' => 'Filtro para las notificaciones',
        'Here you can upload a configuration file to import appointment notifications to your system. The file needs to be in .yml format as exported by the appointment notification module.' =>
            'Aquí puede cargar un archivo de configuración para importar notificaciones de citas a su sistema. El archivo debe estar en formato .yml exportado por el módulo de notificación de citas.',
        'Overwrite existing notifications?' => '¿Sobrescribir las notificaciones existentes?',
        'Upload Notification configuration' => 'Subir configuración de las Notificaciones',
        'Import Notification configuration' => 'Importar la configuración de las Notificaciones',
        'List' => 'Lista',
        'Delete' => 'Borrar',
        'Delete this notification' => 'Eliminar esta notificación',
        'Show in agent preferences' => 'Mostrar en preferencias del agente',
        'Agent preferences tooltip' => 'Información sobre herramientas de preferencias del agente',
        'This message will be shown on the agent preferences screen as a tooltip for this notification.' =>
            'Este mensaje se mostrará en la pantalla de preferencias del agente como información sobre herramientas para esta notificación.',
        'Events' => 'Eventos',
        'Event' => 'Evento',
        'Here you can choose which events will trigger this notification. An additional appointment filter can be applied below to only send for appointments with certain criteria.' =>
            'Aquí puede elegir qué eventos activarán esta notificación. Se puede aplicar un filtro de citas adicional a continuación para enviar citas solo con ciertos criterios.',
        ...
        'Also send if the user is currently out of office.' => 'Envíe también si el usuario se encuentra actualmente fuera de la oficina.',
        ...
        'These are the possible methods that can be used to send this notification to each of the recipients. Please select at least one method below.' =>
            'Estos son los posibles métodos que se pueden utilizar para enviar esta notificación a cada uno de los destinatarios. Seleccione al menos un método a continuación.',
        ...
        'Active by default in agent preferences' => 'Activa por defecto en las preferencias del agente',
        'This is the default value for assigned recipient agents who didn\'t make a choice for this notification in their preferences yet. If the box is enabled, the notification will be sent to such agents.' =>
            'Este es el valor predeterminado para los agentes destinatarios asignados que aún no eligieron esta notificación en sus preferencias. Si la casilla está habilitada, la notificación se enviará a dichos agentes.',
        'This feature is currently not available.' => 'Esta característica no está disponible.',
        'Upgrade to %s' => 'Actualizar a %s',
        'Please activate this transport in order to use it.' => 'Por favor active este transporte para poder utilizarlo.',
        'No data found' => 'Datos no encontrados',
        'No notification method found.' => 'No se encontró ningún método de notificación.',
        'Notification Text' => 'Texto de la Notificación',
        'This language is not present or enabled on the system. This notification text could be deleted if it is not needed anymore.' =>
            'Este idioma no está presente ni habilitado en el sistema. Este texto de notificación podría eliminarse si ya no es necesario.',
        'Remove Notification Language' => 'Eliminar el Idioma de la notificación',
        'Subject' => 'Asunto',
        'Add new notification language' => 'Agregar nuevo idioma de notificación',
        ...
        'Attributes of the recipient user for the notification' => 'Atributos del usuario destinatario de la notificación',
        'Config options' => 'Opciones de configuración',
        'Example notification' => 'Ejemplo de notificación',

        # Template: AdminAppointmentNotificationEventTransportEmailSettings
        'Additional recipient email addresses' => 'Direcciones de correo electrónico de destinatarios adicionales',
        'This field must have less then 200 characters.' => 'Este campo debe tener menos de 200 caracteres.',
        'Article visible for customer' => 'Artículo visible para la cliente',
        ...
        'Use this template to generate the complete email (only for HTML emails).' =>
            'Utilice esta plantilla para generar el correo electrónico completo (solo para correos electrónicos HTML).',
        'Enable email security' => 'Habilitar la seguridad del correo electrónico',
        'Email security level' => 'Nivel de seguridad del correo electrónico',
        'If signing key/certificate is missing' => 'Si falta la clave/certificado de firma',
        'If encryption key/certificate is missing' => 'Si falta la clave/certificado de firma',
        ...
        'Filter for attachments' => 'Filtrar por archivos adjuntos',
        'Filename' => 'Nombre del archivo',
        'Download file' => 'Descargar archivo',
        'Delete this attachment' => 'Eliminar este archivo adjunto',
        'Do you really want to delete this attachment?' => '¿Realmente deseas eliminar este archivo adjunto?',
        'Attachment' => 'Anexo',
        ...
        'To get the name of the ticket\'s customer user (if given).' => 'Para obtener el nombre del usuario cliente del ticket (si se proporciona).',
        ...
        'Options of ticket dynamic fields internal key values' => 'Opciones de valores de clave interna de campos dinámicos de ticket',
        'Options of ticket dynamic fields display values, useful for Dropdown and Multiselect fields' =>
            'Las opciones de los campos dinámicos del ticket muestran valores, útiles para campos desplegables y de selección múltiple',
        'Example response' => 'Ejemplo de respuesta',

        # Template: AdminCloudServiceSupportDataCollector
        'Cloud Service Management' => 'Gestión de Servicios en la Nube',
        'Support Data Collector' => 'Recolector de Datos de Soporte',
        'Support data collector' => 'Recolector de datos de soporte',
        'Hint' => 'Pista',
        'Currently support data is only shown in this system.' => 'Actualmente los datos de soporte solo se muestran en este sistema.',
        ...
        'System Registration is disabled for your system. Please check your configuration.' =>
            'El registro del sistema está deshabilitado para su sistema. Por favor verifique su configuración.',
        ...
        'Please note that the use of OTOBO cloud services requires the system to be registered.' =>
            'Tenga en cuenta que el uso de los servicios en la nube de OTOBO requiere que el sistema esté registrado.',
        'Register this system' => 'Registrar este Sistema',
        'Here you can configure available cloud services that communicate securely with %s.' =>
            'Aquí puede configurar los servicios en la nube disponibles que se comunican de forma segura con usted.',
        ...
        'Show only communication logs created in specific time range.' =>
            'Muestra solo los registros de comunicación creados en un rango de tiempo específico.',
        ...
        'You can change the sort and order of the columns by clicking on the column header.' =>
            'Puede cambiar la clasificación y el orden de las columnas haciendo clic en el encabezado de la columna.',
        ...
        'No account problems' => 'Sin problemas de cuenta',
        'No account activity' => 'Sin actividad en la cuenta',
        'Number of accounts with problems: %s' => 'Numero de cuentas con problemas: %s',
        ...
        'List of communications (%s)' => 'Listado de comunicaciones (%s)',
        ...
        'You can change the sort and order of those columns by clicking on the column header.' =>
            'Puede cambiar la clasificación y el orden de esas columnas haciendo clic en el encabezado de la columna.',
        'Account status for: %s' => 'Estado de cuenta para: %s',
        'Status' => 'Estado',
        'Account' => 'Cuenta',
        'Edit' => 'Editar',
        ...
        'No communication log entries found.' => 'No se encontraron entradas del registro de comunicaciones.',
        ...
        'Detail view for %s communication started at %s' => 'Vista detallada de %s comunicación iniciada en %s',
        'Filter for Log Entries' => 'Filtrar entradas de registro',
        'Filter for log entries' => 'Filtrar entradas de registro',
        'Show only entries with specific priority and higher:' => 'Mostrar solo entradas con prioridad específica y superior:',
        'Communication Log Overview (%s)' => 'Descripción general del registro de comunicación (%s)',
        ...
        'Please select an entry from the list.' => 'Seleccione una entrada de la lista.',

        # Template: AdminContactWD
        'Contact with data management' => 'Contacto con gestión de datos',
        'Contact with data' => 'Contactar con datos',
        ...
        'Select' => 'Seleccionar',
        'Search' => 'Buscar',
        'Wildcards like \'*\' are allowed.' => 'Se permiten comodines como \'*\'.',
        'Please enter a search term to look for contacts with data.' => 'Por favor ingrese un término de búsqueda para buscar contactos con datos.',
        'Valid' => 'Válido',

        # Template: AdminCustomerAccept
        'Privacy Policy Management' => 'Gestión de la Política de Privacidad',
        'Privacy Policy' => 'Política de Privacidad',
        'Remove PrivacyPolicy Language' => 'Eliminar el idioma de la política de privacidad',

        # Template: AdminCustomerCompany
        'Customer Management' => 'Gestión de Clientes',
        'Add Customer' => 'Agregar Cliente',
        'Edit Customer' => 'Modificar Cliente',
        'List (only %s shown - more available)' => 'Lista (solo se muestra %s; hay más disponibles)',
        'total' => 'total',
        ...
        'This customer backend is read only!' => '¡Este backend de cliente es de solo lectura!',

        # Template: AdminCustomerGroup
        'Manage Customer-Group Relations' => 'Gestión de relación entre clientes y grupos',
        'Notice' => 'Aviso',
        'This feature is disabled!' => '¡Esta función está deshabilitada!',
        ...
        'You can manage these groups via the configuration setting "CustomerGroupCompanyAlwaysGroups".' =>
            'Puede administrar estos grupos a través de la configuración "CustomerGroupCompanyAlwaysGroups".',
        ...
        'If nothing is selected, then there are no permissions in this group (tickets will not be available for the customer).' =>
            'Si no selecciona nada, no habrá permisos para este grupo (tickets no estarán disponibles para el cliente).',
        'Search Results' => 'Resultado de la búsqueda',
        'Customers' => 'Clientes',
        'Groups' => 'Grupos',
        'Change Group Relations for Customer' => 'Cambiar las relaciones de grupo para la cliente',
        ...
        'No changes can be made to these groups.' => 'No se pueden realizar cambios en estos grupos.',
        'ro' => 'ro',
        'Read only access to the ticket in this group/queue.' => 'Acceso de solo lectura al ticket en grupo/cola.',
        'rw' => 'rw',
        'Full read and write access to the tickets in this group/queue.' =>
            'Acceso completo de lectura y escritura a los tickets en grupo/fila.',

        # Template: AdminCustomerUser
        'Customer User Management' => 'Administración de Clientes',
        'Add Customer User' => 'Agregar Cliente',
        'Edit Customer User' => 'Editar el Usuario del Cliente',
        'Customer user are needed to have a customer history and to login via customer panel.' =>
            'Se necesita que el usuario del cliente tenga un historial de cliente e inicie sesión a través del panel de cliente.',
        ...
        'This customer backend is read only, but the customer user preferences can be changed!' =>
            'Esta función del cliente es de solo lectura, ¡pero las preferencias del usuario del cliente se pueden cambiar!',
        ...
        'This CustomerID is invalid.' => 'Este ID de cliente no es válido.',
        'Effective Permissions for Customer User' => 'Permisos efectivos para el usuario del cliente',
        'Group Permissions' => 'Permisos de Grupo',
        'This customer user has no group permissions.' => 'Esta usuario del cliente no tiene permisos del grupo.',
        ...
        'Customer Access' => 'Acceso al cliente',
        'Customer' => 'Cliente',
        'This customer user has no customer access.' => 'Este usuario cliente no tiene acceso de cliente.',
        'Table above shows granted customer access for the customer user by permission context. The matrix takes into account all inherited access (e.g. via customer groups). Note: The table does not consider changes made to this form without submitting it.' =>
            'La tabla anterior muestra el acceso de cliente concedido al usuario del cliente por contexto de permiso. La matriz tiene en cuenta todos los accesos heredados (por ejemplo, a través de grupos de clientes). Nota: La tabla no considera los cambios realizados en este formulario sin enviarlo.',

        # Template: AdminCustomerUserCustomer
        'Manage Customer User-Customer Relations' => 'Gestión de Cliente en la relaciones Usuario-Cliente',
        'Select the customer user:customer relations.' => 'Seleccione el cliente en la relación Usuario:Cliente.',
        'Customer Users' => 'Usuarios de clientes',
        'Change Customer Relations for Customer User' => 'Cambiar la relación del cliente para el Usuario del Cliente',
        'Change Customer User Relations for Customer' => 'Cambiar las relaciones del Usuario del Cliente por Cliente',
        'Toggle active state for all' => 'Habilitar el estado activo para todos',
        'Active' => 'Activo',
        'Toggle active state for %s' => 'Habilitar estado activo para %s',

        # Template: AdminCustomerUserGroup
        'Manage Customer User-Group Relations' => 'Gestionar las relaciones de los Clientes entre Usuario-Grupo',
        'Just use this feature if you want to define group permissions for customer users.' =>
            'Simplemente utilice esta función si desea definir permisos de grupo para los usuarios de los clientes.',
        'Edit Customer User Default Groups' => 'Editar Grupos como Predeterminados para los Usuarios del Cliente',
        ...
        'Filter for groups' => 'Filtros por grupos',
        'Select the customer user - group permissions.' => 'Seleccione los permisos del Usuario del Cliente - Grupo.',
        'If nothing is selected, then there are no permissions in this group (tickets will not be available for the customer user).' =>
            'Si no se selecciona nada, entonces no hay permisos en este grupo (los Tickets no estarán disponibles para el usuario del cliente).',
        'Customer User Default Groups:' => 'Grupos por defecto para el Usuario del Cliente:',

        # Template: AdminCustomerUserService
        'Manage Customer User-Service Relations' => 'Gestión de Relación de Usuario del Cliente - Servicio',
        ...
        'Use external databases as configurable data sources for this dynamic field.' =>
            'Usa las bases de datos externas cómo las fuentes configurables de datos para éste campo dinámico.',
        ...
        'This feature allows to add (multiple) contacts with data to tickets.' =>
            'Este campo permite agregar (múltiples) contactos con datos a los Tickets.',
        'To add a new field, select the field type from one of the object\'s list, the object defines the boundary of the field and it can\'t be changed after the field creation.' =>
            'Para agregar un campo nuevo, seleccione el tipo de campo de la lista de objetos, el objeto define los limites del campo y no puede ser cambiado después de la creación del campo.',
        ...
        'DynamicFields Import' => 'Importar Campos Dinámicos',
        'DynamicFields Export' => 'Exportar Campos Dinámicos',
        'Dynamic Fields Screens' => 'Pantallas de los Campos Dinámicos',
        ...
        'This field is required, and the value should be alphabetic and numeric characters only.' =>
            'Este campo es obligatorio y el valor debe contener únicamente caracteres alfabéticos y numéricos.',
        'Must be unique and only accept alphabetic and numeric characters.' =>
            'Debe ser único y aceptar únicamente caracteres alfabéticos y numéricos.',
        'Changing this value will require manual changes in the system.' =>
            'Cambiar este valor requerirá cambios manuales en el sistema.',
        'This is the name to be shown on the screens where the field is active.' =>
            'Este es el nombre que se mostrará en las pantallas cuando el campo esté activo.',
        ...
        'This is the order in which this field will be shown on the screens where is active.' =>
            'Este es el orden en el que se mostrará este campo en las pantallas cuando esté activo.',
        'Tooltip message:' => 'Mensaje de descripción emergente:',
        'This is the tooltip message shown inside the customer interface.' =>
            'Este es el mensaje de información que se muestra dentro de la interfaz del cliente.',
        'Is not possible to invalidate this entry, all config settings have to be changed beforehand.' =>
            'No es posible invalidar esta entrada, todas las configuraciones deben cambiarse de antemano.',
        'Field type' => 'Tipo de campo',
        'Object type' => 'Tipo de objeto',
        'Internal field' => 'Campo interno',
        'This field is protected and can\'t be deleted.' => 'Este campo está protegido y no se puede eliminar.',
        'This dynamic field is used in the following config settings:' =>
            'Este campo dinámico se utiliza en las siguientes configuraciones:',
        ...
        'Add or edit contacts' => 'Agregar o editar contactos',
        'To add contacts to this field please fill out all the needed information and save it.' =>
            'Para agregar contactos a este campo, complete toda la información necesaria y guárdela.',
        'Click on the field name from the overview to edit it and find the corresponding action in the sidebar or from the \'Tickets\' menu.' =>
            'Haga clic en el nombre del campo en la descripción general para editarlo y buscar la acción correspondiente en la barra lateral o en el menú \'Tickets\'.',
        'Name Field' => 'Nombre del Campo',
        'ValidID Field' => 'ID del Campo válido',
        ...
        'Comma separated list of mandatory keys (optional). Keys \'Name\' and \'ValidID\' are always mandatory and doesn\'t have to be listed here.' =>
            'Lista separada por comas de clave obligatoria (opcionales). Las claves \'Nombre\' y \'ValidID\' siempre son obligatorias y no es necesario que aparezcan aquí.',
        'Sorted fields' => 'Campos ordenados',
        'Comma separated list of keys in sort order (optional). Keys listed here come first, all remaining fields afterwards and sorted alphabetically.' =>
            'Lista de claves separadas por comas en orden de clasificación (opcional). Las claves enumeradas aquí aparecen primero, todos los campos restantes después y ordenados alfabéticamente.',
        'Searchable fields' => 'Búsqueda de campos',
        'Comma separated list of searchable keys (optional). Key \'Name\' is always searchable and doesn\'t have to be listed here.' =>
            'Lista separada por comas de claves de búsqueda (opcional). La clave \'Nombre\' siempre se puede buscar y no es necesario que aparezca aquí.',
        'Translatable values' => 'Valores traducibles',
        'If you activate this option the values will be translated to the user defined language.' =>
            'Si usted activa esta opción los valores serán traducidos al idioma predefinido por el usuario.',
        'Note' => 'Nota',
        'You need to add the translations manually into the language translation files.' =>
            'Debe agregar las traducciones manualmente en los archivos de traducción de idiomas.',
        ...
        'You can reference the field with its own field name. You can also refer to other fields, e.g. with \'DynamicField_OtherFieldName\'.' =>
            'Puede hacer referencia al campo con mismo nombre de campo. También puede consultar otros campos, p. con \'DynamicField_OtherFieldName\'.',
        ...
        'Years in the past to display (default: 5 years).' => 'Años en el pasado para mostrar (predeterminado: 5 años).',
        'Years in the future' => 'Años en el futuro',
        'Years in the future to display (default: 5 years).' => 'Años en el futuro para mostrar (predeterminado: 5 años).',
        ...
        'Here you can restrict the entering of dates of tickets.' => 'Aquí puede restringir el ingreso de fechas de los tickets.',
        ...
        'Tree View' => 'Vista del Arbol',
        'Activate this option to display values as a tree.' => 'Active esta opción para mostrar valores como un árbol.',
        ...
        'Overview' => 'Resumen',
        'Default Columns Screens' => 'Pantallas de Columnas por Defecto',
        ...
        'You can assign elements to this Screen/Field by dragging the elements with the mouse from the left list to the right list.' =>
            'Puede asignar elementos a esta pantalla/campo arrastrando los elementos con el mouse desde la lista de la izquierda a la lista de la derecha.',
        'Ordering the elements within the list is also possible by drag \'n\' drop.' =>
            'También es posible ordenar los elementos dentro de la lista arrastrando y soltando.',
        'Filter available elements' => 'Filtrar elementos disponibles',
        'selected to available elements' => 'Seleccionado según los elementos disponibles',
        ...
        'Disabled Elements' => 'Elementos deshabilitados',
        'Filter assigned elements' => 'Filtrar elementos asignados',
        'selected to assigned elements' => 'seleccionado para elementos asignados',
        'Toggle all assigned elements' => 'Alternar todos los elementos asignados',
        'Assigned Elements' => 'Elementos asignados',
        'Filter assigned required elements' => 'Filtrar elementos requeridos asignados',
        'selected to assigned required elements' => 'seleccionado para asignar elementos requeridos',
        'Toggle all assigned required elements' => 'Alternar todos los elementos requeridos asignados',
        ...
        'Specify the width (in characters) for this field in the edit mode.' =>
            'Especifique el tamaño (en caracteres) para este campo en el modo de edición.',
        'Check RegEx' => 'Comprobar expresión regular',
        'Here you can specify a regular expression to check the value. The regex will be executed with the modifiers xms.' =>
            'Aquí puede especificar una expresión regular para verificar el valor. La expresión regular se ejecutará con los modificadores xms.',
        'RegEx' => 'Expresión Regular',
        'Invalid RegEx' => 'Invalidar Expresión Regular',
        ...
        'Size' => 'Tamaño',
        'Font size of the label.' => 'Estilo de fuente de la etiqueta.',
        'Color in hex.' => 'Color en hexadecimal.',

        # Template: AdminDynamicFieldWebService
        'This field is required' => 'Este campo es obligatorio',
        'The web service to be executed for possible values.' => 'El servicio web que se ejecutará para los posibles valores.',
        'Invoker' => 'Invocador',
        'The invoker to be used to perform requests (invoker needs to be of type \'Generic::PassThrough\').' =>
            'El invocador que se utilizará para realizar solicitudes (el invocador debe ser del tipo \'Generic::PassThrough\').',
        ...
        'Cache time to live (in minutes), to save the retrieved possible values.' =>
            'Tiempo de vida de la caché (en minutos) para guardar los posibles valores recuperados.',
        'Here you can specify an optional HTTP link for the field value in Overviews and Zoom screens. Optional HTTP link works only for single-select fields.' =>
            'Aquí puede especificar un enlace HTTP opcional para el valor del campo en las pantallas Descripción general y Zoom. El enlace HTTP opcional solo funciona para campos de selección única.',
        ...
        'Your message was sent to' => 'Mensaje fue enviado a',
        'From' => 'De',
        ...
        'Generic Agent Job Management' => 'Gestión de Trabajos de Agentes Genéricos',
        'Edit Job' => 'Editar Trabajo',
        'Add Job' => 'Agregar Trabajo',
        'Run Job' => 'Ejecución de Trabajo',
        'Filter for Jobs' => 'Filtrar por Trabajos',
        'Filter for jobs' => 'Filtrar por trabajos',
        'Last run' => 'Última ejecución',
        'Run Now!' => 'Ejecutar Ahora!',
        'Delete this task' => 'Eliminar esta tarea',
        'Run this task' => 'Ejecutar esta tarea',
        'Job Settings' => 'Configuración de trabajo',
        'Job name' => 'Nombre del trabajo',
        'The name you entered already exists.' => 'El nombre que ingresaste ya existe.',
        'Automatic Execution (Multiple Tickets)' => 'Ejecución Automática (Múltiples Tickets)',
        'Execution Schedule' => 'Planificar Ejecución',
        'Schedule minutes' => 'Minutos para la planificación',
        'Schedule hours' => 'Horas para planificar',
        ...
        'Additionally or alternatively to a periodic execution, you can define ticket events that will trigger this job.' =>
            'Además o como alternativa a una ejecución periódica, puede definir eventos de ticket que activarán este trabajo.',
        'If a ticket event is fired, the ticket filter will be applied to check if the ticket matches. Only then the job is run on that ticket.' =>
            'Si se activa un evento de ticket, se aplicará el filtro de ticket para verificar si el ticket coincide. Sólo entonces se ejecuta el trabajo en ese ticket.',
        'Do you really want to delete this event trigger?' => '¿Realmente deseas eliminar este disparador del evento?',
        'Add Event Trigger' => 'Agregar el Disparador del Evento',
        ...
        'Customer user ID' => 'ID del Cliente',
        '(e. g. U5150)' => '(ej: U5150)',
        ...
        'Create times' => 'Fecha de Creación',
        'No create time settings.' => 'No hay fecha de creación.',
        'Ticket created' => 'Ticket creado',
        'Ticket created between' => 'Ticket creado entre',
        'and' => 'y',
        'Last changed times' => 'Ultima fecha de cambio',
        'No last changed time settings.' => 'Últimas fechas modificadas.',
        'Ticket last changed' => 'Ultima Fecha de cambio',
        'Ticket last changed between' => 'Ultima fecha de cambio entre',
        'Change times' => 'Fecha de cambio',
        ...
        'Last close times' => 'Ultima fecha de cierre',
        'No last close time settings.' => 'No hay modificaciones en la ultima fecha de cierre.',
        'Ticket last close' => 'Ultimo cierre del Ticket',
        'Ticket last close between' => 'Último cierre del ticket entre',
        'Close times' => 'Fecha de Cierre',
        'No close time settings.' => 'No hay configuraciones para la fecha de cierre.',
        'Ticket closed' => 'Ticket cerrado',
        'Ticket closed between' => 'Ticket cerrado entre',
        'Pending times' => 'Fecha Pendiente',
        'No pending time settings.' => 'No hay configuraciones para la fecha pendiente',
        'Ticket pending time reached' => 'Alcanzada la fecha pendiente del ticket',
        'Ticket pending time reached between' => 'Fecha pendiente del ticket a sido alcanzada',
        'Escalation times' => 'Fecha de escalamiento',
        'No escalation time settings.' => 'No existen configuraciones para fecha de escalamiento',
        'Ticket escalation time reached' => 'Fecha de escalamiento del Ticket ha sido alcanzado',
        'Ticket escalation time reached between' => 'Fecha de escalamiento del Ticket ha sido alcanzado entre',
        'Escalation - first response time' => 'Escalamiento - fecha para la primera respuesta',
        'Ticket first response time reached' => 'Fecha para la primer respuesta del Ticket ha sido alcanzado',
        'Ticket first response time reached between' => 'La fecha de la primer respuesta del Ticket ha sido alcanzado entre',
        'Escalation - update time' => 'Escalamiento - Fecha para la actualización',
        'Ticket update time reached' => 'La fecha actualización del Ticket ha sido alcanzado',
        'Ticket update time reached between' => 'La fecha de actualización del Ticket ha sido alcanzado entre',
        'Escalation - solution time' => 'Escalamiento - fecha de solución',
        'Ticket solution time reached' => 'Fecha para la solución del Ticket ha sido alcanzado',
        ...
        'Update/Add Ticket Attributes' => 'Actualizar/Agregar atributos de ticket',
        ...
        'New customer user ID' => 'Nuevo ID de usuario del cliente',
        ...
        'Execute Ticket Commands' => 'Ejecutar comandos de tickets',
        ...
        'Warning: There are %s tickets affected but only %s may be modified during one job execution!' =>
            'Advertencia: ¡Hay %s tickets afectados pero solo %s pueden modificarse durante la ejecución de un trabajo!',
        ...
        'Do you really want to delete this error handling module?' => '¿Realmente desea eliminar este módulo de manejo de errores?',
        ...
        'The name can be used to distinguish different error handling configurations.' =>
            'El nombre se puede utilizar para distinguir diferentes configuraciones de manejo de errores.',
        'Please provide a unique name for this web service.' => 'Proporcione un nombre único para este servicio web.',
        'Error handling module backend' => 'Módulo de manejo de errores en el backend',
        'This OTOBO error handling backend module will be called internally to process the error handling mechanism.' =>
            'Este módulo backend de manejo de errores de OTOBO se llamará internamente para procesar el mecanismo de manejo de errores.',
        ...
        'Only requests matching all configured filters (if any) will trigger module execution.' =>
            'Solo las solicitudes que coincidan con todos los filtros configurados (si los hay) activarán la ejecución del módulo.',
        'Operation filter' => 'Filtro de operación',
        'Only execute error handling module for selected operations.' => 'Ejecute solo el módulo de manejo de errores para operaciones seleccionadas.',
        'Note: Operation is undetermined for errors occuring while receiving incoming request data. Filters involving this error stage should not use operation filter.' =>
            'Nota: La operación no está determinada por errores que ocurren al recibir datos de solicitud entrantes. Los filtros que involucran esta etapa de error no deben usar el filtro de operación.',
        'Invoker filter' => 'Filtro de invocador',
        'Only execute error handling module for selected invokers.' => 'Ejecute solo el módulo de manejo de errores para los invocadores seleccionados.',
        'Error message content filter' => 'Filtro de contenido de mensajes de error',
        ...
        'Error message subject and data (as seen in the debugger error entry) will considered for a match.' =>
            'El asunto y los datos del mensaje de error (como se ven en la entrada de error del depurador) se considerarán para una coincidencia.',
        'Example: Enter \'^.*401 Unauthorized.*\$\' to handle only authentication related errors.' =>
            'Ejemplo: Ingrese \'^.*401 No autorizado.*\$\' para manejar solo los errores relacionados con la autenticación.',
        'Error stage filter' => 'Filtro de etapa de error',
        'Only execute error handling module on errors that occur during specific processing stages.' =>
            'Ejecute únicamente el módulo de manejo de errores en errores que ocurran durante etapas de procesamiento específicas.',
        'Example: Handle only errors where mapping for outgoing data could not be applied.' =>
            'Ejemplo: Manejar solo errores en los que no se pudo aplicar la asignación de datos salientes.',
