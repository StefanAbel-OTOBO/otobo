...
sub Data {
    ...
    $Self->{Completeness}        = 0.214806594800254;
    ...
    $Self->{Translation} = {
        ...
        'A new database user with limited permissions will be created for this OTOBO system.' =>
            'Novi korisnik baze sa ograničenim pravima bit će  kreiran za ovaj OTOBO sustav',
        'Generated password' => '',
        'Repeat Password' => '',
        ...
        'After doing so your OTOBO is up and running.' => 'Nakon ovoga Vaš OTOBO je uključen i radi.',
        ...
        # Template: Test
        'OTOBO Test Page' => 'OTOBO test stranica',
        'Unlock' => 'Otključano',
        'Welcome %s %s' => '',
        'Counter' => 'Brojač',
...
' => '',
        ...
        'Your email with ticket number "<OTOBO_TICKET>" is merged to "<OTOBO_MERGE_TO_TICKET>".' =>
            'Vaša poruka E-pošte sa brojem kartice "<OTOBO_TICKET>" je objedinjena sa karticom "<OTOBO_MERGE_TO_TICKET>"!',
