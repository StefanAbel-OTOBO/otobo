...
sub Data {
    ...
    $Self->{Completeness}        = 0.155180801037782;
    ...
    $Self->{Translation} = {
        ...
        'To be able to use OTOBO you have to enter the following line in your command line (Terminal/Shell) as root.' =>
            'Lai varētu izmantot OTOBO, sekojošā komanda jāizpilda terminālī/čaulā.',
        'Restart your webserver' => 'Pārstartējiet tīmekļa serveri (webserver).',
        'After doing so your OTOBO is up and running.' => 'Pēc tam OTOBO būs darba kārtībā un palaists.',
        'Start page' => 'Sākumlapa',
        'Your OTOBO Team' => 'Jūsu OTOBO komanda',
        ...
        # Template: Test
        'OTOBO Test Page' => 'OTOBO problēmu pieteikumu sistēmas testa lapa',
        'Unlock' => 'Atslēgt',
        'Welcome %s %s' => '',
        'Counter' => 'Skaitītājs',
        ...
        'OTOBO as provider' => '',
        'Operations' => '',
        'OTOBO as requester' => 'OTOBO kā pieprasītājs',
        'Invokers' => '',
        ...
        'Install OTOBO' => 'Instalējiet OTOBO',
        'Intro' => '',
        ...
        'OTOBO Disk Partition' => 'OTOBO diska nodalījums',
...
' => '',
        ...
        'New process ticket' => '',
        'News about OTOBO releases!' => 'Ziņas par OTOBO relīzēm!',
        'News about OTOBO.' => '',
        ...
        'Your email with ticket number "<OTOBO_TICKET>" is merged to "<OTOBO_MERGE_TO_TICKET>".' =>
            'Jūsu e-pasts ar pieteikuma numuru "<OTOBO_TICKET>" ir apvienots ar pieteikumu nr. "<OTOBO_MERGE_TO_TICKET>"!',
