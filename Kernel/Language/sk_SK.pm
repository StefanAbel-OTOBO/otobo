...
sub Data {
    ...
    $Self->{Completeness}        = 0.170423220366467;
...
' => '',
        ...
        'New process ticket' => '',
        'News about OTOBO releases!' => 'Novinky o OTOBO vydaniach!',
        'News about OTOBO.' => '',
        ...
        'Product News' => 'Produktové novinky',
        ...
        'Your email with ticket number "<OTOBO_TICKET>" is merged to "<OTOBO_MERGE_TO_TICKET>".' =>
            'Váš e-mail na tikete číslo "<OTOBO_TICKET>" bol zlúčený do "<OTOBO_MERGE_TO_TICKET>".',
