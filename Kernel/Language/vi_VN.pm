...
sub Data {
    ...
    $Self->{Completeness}        = 0.147559591373439;
...
' => '',
        ...
        'New process ticket' => '',
        'News about OTOBO releases!' => 'Tin tức về phiên bản OTOBO',
        'News about OTOBO.' => '',
        ...
        'Your email with ticket number "<OTOBO_TICKET>" is merged to "<OTOBO_MERGE_TO_TICKET>".' =>
            'E-mail của bạn với số thẻ "<OTOBO_TICKET>" được trộn thành "<OTOBO_MERGE_TO_TICKET>"!',
