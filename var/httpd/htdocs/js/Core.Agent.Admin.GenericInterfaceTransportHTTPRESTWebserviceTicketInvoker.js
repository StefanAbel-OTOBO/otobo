...
/**
 * @namespace Core.Agent.Admin.GenericInterfaceTransportHTTPRESTWebserviceTicketInvoker
 * @memberof Core.Agent.Admin
 * @author Rother OSS GmbH
 * @description
 *      This namespace contains the special module functions for the GenericInterface Transport HTTP REST module.
 */
Core.Agent.Admin.GenericInterfaceTransportHTTPRESTWebserviceTicketInvoker = (function (TargetNS) {
    ...
    return TargetNS;
}(Core.Agent.Admin.GenericInterfaceTransportHTTPRESTWebserviceTicketInvoker || {}));
